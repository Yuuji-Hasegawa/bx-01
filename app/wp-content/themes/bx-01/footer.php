...
<div class="o-stack o-stack:bottomLogo">
    <a href="<?php echo home_url();?>" class="c-bottom-logo"><?php echo get_vars('site', 'name');?></a>
    <span class="c-bottom-address">〒<?php echo get_vars('company', 'zip');?>
